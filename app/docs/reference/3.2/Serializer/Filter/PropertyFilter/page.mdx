...
# [ApiPlatform\Serializer\Filter\PropertyFilter](/docs/v3.2/reference/Serializer/Filter/PropertyFilter)
...
```php
class ApiPlatform\Serializer\Filter\PropertyFilter implements `<a href="/docs/v3.2/reference/Serializer/Filter/FilterInterface">ApiPlatform\Serializer\Filter\FilterInterface</a>`, `<a href="/docs/v3.2/reference/Api/FilterInterface">ApiPlatform\Api\FilterInterface</a>`
{
