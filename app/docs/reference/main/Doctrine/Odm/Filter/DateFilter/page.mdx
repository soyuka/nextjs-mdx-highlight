...
# [ApiPlatform\Doctrine\Odm\Filter\DateFilter](/docs/vmain/reference/Doctrine/Odm/Filter/DateFilter)
...
```php
class ApiPlatform\Doctrine\Odm\Filter\DateFilter extends `<a href="/docs/vmain/reference/Doctrine/Odm/Filter/AbstractFilter">ApiPlatform\Doctrine\Odm\Filter\AbstractFilter</a>` implements `<a href="/docs/vmain/reference/Doctrine/Odm/Filter/FilterInterface">ApiPlatform\Doctrine\Odm\Filter\FilterInterface</a>`, `<a href="/docs/vmain/reference/Metadata/FilterInterface">ApiPlatform\Metadata\FilterInterface</a>`, `<a href="/docs/vmain/reference/Doctrine/Common/Filter/DateFilterInterface">ApiPlatform\Doctrine\Common\Filter\DateFilterInterface</a>`
{
