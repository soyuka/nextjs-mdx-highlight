...
# [ApiPlatform\Metadata\FilterInterface](/docs/v3.1/reference/Metadata/FilterInterface)
...
#### See also
- [getFiltersParameters](/docs/v3.1/reference/OpenApi/Factory/OpenApiFactory#getFiltersParameters)
