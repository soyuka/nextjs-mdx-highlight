...
# [ApiPlatform\Serializer\Filter\FilterInterface](/docs/v3.1/reference/Serializer/Filter/FilterInterface)

Symfony serializer context builder filter interface.


```php
interface ApiPlatform\Serializer\Filter\FilterInterface implements `<a href="/docs/v3.1/reference/Api/FilterInterface">ApiPlatform\Api\FilterInterface</a>`, `<a href="/docs/v3.1/reference/Metadata/FilterInterface">ApiPlatform\Metadata\FilterInterface</a>`
{
