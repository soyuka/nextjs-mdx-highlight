...
# [ApiPlatform\JsonSchema\Command\JsonSchemaGenerateCommand](/docs/v3.1/reference/JsonSchema/Command/JsonSchemaGenerateCommand)
...
{
    public __construct(`<a href="/docs/v3.1/reference/JsonSchema/SchemaFactoryInterface">ApiPlatform\JsonSchema\SchemaFactoryInterface</a>` $schemaFactory, array $formats)
...
<table><tbody>
<tr><td>schemaFactory</td><td>`<a href="/docs/v3.1/reference/JsonSchema/SchemaFactoryInterface">ApiPlatform\JsonSchema\SchemaFactoryInterface</a>`</td><td></td></tr><tr><td>formats</td><td>array</td><td></td></tr>
</tbody>
</table>
