...
# [ApiPlatform\Doctrine\Odm\Filter\OrderFilter](/docs/vmain/reference/Doctrine/Odm/Filter/OrderFilter)
...
```php
class ApiPlatform\Doctrine\Odm\Filter\OrderFilter extends `<a href="/docs/vmain/reference/Doctrine/Odm/Filter/AbstractFilter">ApiPlatform\Doctrine\Odm\Filter\AbstractFilter</a>` implements `<a href="/docs/vmain/reference/Doctrine/Odm/Filter/FilterInterface">ApiPlatform\Doctrine\Odm\Filter\FilterInterface</a>`, `<a href="/docs/vmain/reference/Metadata/FilterInterface">ApiPlatform\Metadata\FilterInterface</a>`, `<a href="/docs/vmain/reference/Doctrine/Common/Filter/OrderFilterInterface">ApiPlatform\Doctrine\Common\Filter\OrderFilterInterface</a>`
{
    ...
    protected filterProperty(string $property, $direction, Doctrine\ODM\MongoDB\Aggregation\Builder $aggregationBuilder, string $resourceClass, null|`<a href="/docs/vmain/reference/Metadata/Operation">ApiPlatform\Metadata\Operation</a>` $operation, array $context): null
