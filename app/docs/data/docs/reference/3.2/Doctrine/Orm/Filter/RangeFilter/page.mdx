...
# [ApiPlatform\Doctrine\Orm\Filter\RangeFilter](/docs/v3.2/reference/Doctrine/Orm/Filter/RangeFilter)
...
```php
class ApiPlatform\Doctrine\Orm\Filter\RangeFilter extends `<a href="/docs/v3.2/reference/Doctrine/Orm/Filter/AbstractFilter">ApiPlatform\Doctrine\Orm\Filter\AbstractFilter</a>` implements `<a href="/docs/v3.2/reference/Doctrine/Orm/Filter/FilterInterface">ApiPlatform\Doctrine\Orm\Filter\FilterInterface</a>`, `<a href="/docs/v3.2/reference/Api/FilterInterface">ApiPlatform\Api\FilterInterface</a>`, `<a href="/docs/v3.2/reference/Doctrine/Common/Filter/RangeFilterInterface">ApiPlatform\Doctrine\Common\Filter\RangeFilterInterface</a>`
{
    ...
    protected addWhere(Doctrine\ORM\QueryBuilder $queryBuilder, `<a href="/docs/v3.2/reference/Doctrine/Orm/Util/QueryNameGeneratorInterface">ApiPlatform\Doctrine\Orm\Util\QueryNameGeneratorInterface</a>` $queryNameGenerator, string $alias, string $field, string $operator, string $value): null
