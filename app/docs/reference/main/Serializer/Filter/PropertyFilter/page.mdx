...
# [ApiPlatform\Serializer\Filter\PropertyFilter](/docs/vmain/reference/Serializer/Filter/PropertyFilter)
...
```php
class ApiPlatform\Serializer\Filter\PropertyFilter implements `<a href="/docs/vmain/reference/Serializer/Filter/FilterInterface">ApiPlatform\Serializer\Filter\FilterInterface</a>`, `<a href="/docs/vmain/reference/Metadata/FilterInterface">ApiPlatform\Metadata\FilterInterface</a>`
{
