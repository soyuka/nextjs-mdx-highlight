...
# [ApiPlatform\Doctrine\Common\Filter\DateFilterTrait](/docs/vmain/reference/Doctrine/Common/Filter/DateFilterTrait)

Trait for filtering the collection by date intervals.


```php
trait ApiPlatform\Doctrine\Common\Filter\DateFilterTrait
{
