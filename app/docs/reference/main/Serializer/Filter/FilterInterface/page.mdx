...
# [ApiPlatform\Serializer\Filter\FilterInterface](/docs/vmain/reference/Serializer/Filter/FilterInterface)

Symfony serializer context builder filter interface.


```php
interface ApiPlatform\Serializer\Filter\FilterInterface implements `<a href="/docs/vmain/reference/Metadata/FilterInterface">ApiPlatform\Metadata\FilterInterface</a>`
{
