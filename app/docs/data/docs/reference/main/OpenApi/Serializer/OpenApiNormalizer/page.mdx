...
# [ApiPlatform\OpenApi\Serializer\OpenApiNormalizer](/docs/vmain/reference/OpenApi/Serializer/OpenApiNormalizer)

Generates an OpenAPI v3 specification.

```php
class ApiPlatform\OpenApi\Serializer\OpenApiNormalizer implements Symfony\Component\Serializer\Normalizer\NormalizerInterface, `<a href="/docs/vmain/reference/OpenApi/Serializer/CacheableSupportsMethodInterface">ApiPlatform\OpenApi\Serializer\CacheableSupportsMethodInterface</a>`
{
