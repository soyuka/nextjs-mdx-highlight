...
# [ApiPlatform\Doctrine\Odm\Filter\ExistsFilter](/docs/v3.2/reference/Doctrine/Odm/Filter/ExistsFilter)
...
```php
class ApiPlatform\Doctrine\Odm\Filter\ExistsFilter extends `<a href="/docs/v3.2/reference/Doctrine/Odm/Filter/AbstractFilter">ApiPlatform\Doctrine\Odm\Filter\AbstractFilter</a>` implements `<a href="/docs/v3.2/reference/Doctrine/Odm/Filter/FilterInterface">ApiPlatform\Doctrine\Odm\Filter\FilterInterface</a>`, `<a href="/docs/v3.2/reference/Api/FilterInterface">ApiPlatform\Api\FilterInterface</a>`, `<a href="/docs/v3.2/reference/Doctrine/Common/Filter/ExistsFilterInterface">ApiPlatform\Doctrine\Common\Filter\ExistsFilterInterface</a>`
{
