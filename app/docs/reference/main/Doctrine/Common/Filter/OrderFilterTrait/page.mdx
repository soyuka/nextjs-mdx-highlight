...
# [ApiPlatform\Doctrine\Common\Filter\OrderFilterTrait](/docs/vmain/reference/Doctrine/Common/Filter/OrderFilterTrait)

Trait for ordering the collection by given properties.


```php
trait ApiPlatform\Doctrine\Common\Filter\OrderFilterTrait
{
