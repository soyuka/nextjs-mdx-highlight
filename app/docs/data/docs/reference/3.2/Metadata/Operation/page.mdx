...
# [ApiPlatform\Metadata\Operation](/docs/v3.2/reference/Metadata/Operation)

⚠ This class and its children offer no backward compatibility regarding positional parameters.

```php
class ApiPlatform\Metadata\Operation extends `<a href="/docs/v3.2/reference/Metadata/Metadata">ApiPlatform\Metadata\Metadata</a>`
{
