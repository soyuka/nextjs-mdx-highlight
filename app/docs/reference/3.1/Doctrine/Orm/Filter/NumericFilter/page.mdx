...
# [ApiPlatform\Doctrine\Orm\Filter\NumericFilter](/docs/v3.1/reference/Doctrine/Orm/Filter/NumericFilter)
...
```php
class ApiPlatform\Doctrine\Orm\Filter\NumericFilter extends `<a href="/docs/v3.1/reference/Doctrine/Orm/Filter/AbstractFilter">ApiPlatform\Doctrine\Orm\Filter\AbstractFilter</a>` implements `<a href="/docs/v3.1/reference/Api/FilterInterface">ApiPlatform\Api\FilterInterface</a>`, `<a href="/docs/v3.1/reference/Metadata/FilterInterface">ApiPlatform\Metadata\FilterInterface</a>`, `<a href="/docs/v3.1/reference/Doctrine/Orm/Filter/FilterInterface">ApiPlatform\Doctrine\Orm\Filter\FilterInterface</a>`
{
