...
# [ApiPlatform\OpenApi\Serializer\OpenApiNormalizer](/docs/v3.1/reference/OpenApi/Serializer/OpenApiNormalizer)

Generates an OpenAPI v3 specification.

```php
class ApiPlatform\OpenApi\Serializer\OpenApiNormalizer implements Symfony\Component\Serializer\Normalizer\NormalizerInterface, `<a href="/docs/v3.1/reference/OpenApi/Serializer/CacheableSupportsMethodInterface">ApiPlatform\OpenApi\Serializer\CacheableSupportsMethodInterface</a>`
{
