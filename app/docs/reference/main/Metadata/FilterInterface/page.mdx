...
# [ApiPlatform\Metadata\FilterInterface](/docs/vmain/reference/Metadata/FilterInterface)
...
#### See also
- [getFiltersParameters](/docs/vmain/reference/OpenApi/Factory/OpenApiFactory#getFiltersParameters)
