...
# [ApiPlatform\Doctrine\Odm\Extension\OrderExtension](/docs/v3.1/reference/Doctrine/Odm/Extension/OrderExtension)

Applies selected ordering while querying resource collection.


```php
class ApiPlatform\Doctrine\Odm\Extension\OrderExtension implements `<a href="/docs/v3.1/reference/Doctrine/Odm/Extension/AggregationCollectionExtensionInterface">ApiPlatform\Doctrine\Odm\Extension\AggregationCollectionExtensionInterface</a>`
{
