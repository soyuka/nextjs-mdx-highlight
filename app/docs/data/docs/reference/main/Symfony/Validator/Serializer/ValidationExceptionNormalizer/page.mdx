...
# [ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer](/docs/vmain/reference/Symfony/Validator/Serializer/ValidationExceptionNormalizer)



```php
class ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer implements Symfony\Component\Serializer\Normalizer\NormalizerInterface, `<a href="/docs/vmain/reference/Serializer/CacheableSupportsMethodInterface">ApiPlatform\Serializer\CacheableSupportsMethodInterface</a>`
{
