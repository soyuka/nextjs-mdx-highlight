...
# [ApiPlatform\GraphQl\Serializer\Exception\HttpExceptionNormalizer](/docs/vmain/reference/GraphQl/Serializer/Exception/HttpExceptionNormalizer)

Normalize HTTP exceptions.


```php
class ApiPlatform\GraphQl\Serializer\Exception\HttpExceptionNormalizer implements Symfony\Component\Serializer\Normalizer\NormalizerInterface
{
