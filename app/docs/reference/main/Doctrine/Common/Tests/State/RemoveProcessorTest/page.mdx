...
# [ApiPlatform\Doctrine\Common\Tests\State\RemoveProcessorTest](/docs/vmain/reference/Doctrine/Common/Tests/State/RemoveProcessorTest)



```php
class ApiPlatform\Doctrine\Common\Tests\State\RemoveProcessorTest extends PHPUnit\Framework\TestCase implements Countable, PHPUnit\Framework\Test, PHPUnit\Framework\SelfDescribing, PHPUnit\Framework\Reorderable
{
    public testConstruct(): null
    public testRemove(): null
    public testRemoveWithNullManager(): null
