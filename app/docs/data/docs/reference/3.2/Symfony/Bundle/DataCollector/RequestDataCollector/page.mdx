...
# [ApiPlatform\Symfony\Bundle\DataCollector\RequestDataCollector](/docs/v3.2/reference/Symfony/Bundle/DataCollector/RequestDataCollector)
...
{
    public __construct(`<a href="/docs/v3.2/reference/Metadata/Resource/Factory/ResourceMetadataCollectionFactoryInterface">ApiPlatform\Metadata\Resource\Factory\ResourceMetadataCollectionFactoryInterface</a>` $metadataFactory, Psr\Container\ContainerInterface $filterLocator)
...
<table><tbody>
<tr><td>metadataFactory</td><td>`<a href="/docs/v3.2/reference/Metadata/Resource/Factory/ResourceMetadataCollectionFactoryInterface">ApiPlatform\Metadata\Resource\Factory\ResourceMetadataCollectionFactoryInterface</a>`</td><td></td></tr><tr><td>filterLocator</td><td>Psr\Container\ContainerInterface</td><td></td></tr>
</tbody>
</table>
