...
# [ApiPlatform\Symfony\Bundle\Command\GraphQlExportCommand](/docs/v3.2/reference/Symfony/Bundle/Command/GraphQlExportCommand)
...
{
    public __construct(`<a href="/docs/v3.2/reference/GraphQl/Type/SchemaBuilderInterface">ApiPlatform\GraphQl\Type\SchemaBuilderInterface</a>` $schemaBuilder)
...
<table><tbody>
<tr><td>schemaBuilder</td><td>`<a href="/docs/v3.2/reference/GraphQl/Type/SchemaBuilderInterface">ApiPlatform\GraphQl\Type\SchemaBuilderInterface</a>`</td><td></td></tr>
</tbody>
</table>
