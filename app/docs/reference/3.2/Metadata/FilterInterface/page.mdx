...
# [ApiPlatform\Api\FilterInterface](/docs/v3.2/reference/Api/FilterInterface)

Filters applicable on a resource.


```php
interface ApiPlatform\Api\FilterInterface
{
...
#### See also
- [getFiltersParameters](/docs/v3.2/reference/OpenApi/Factory/OpenApiFactory#getFiltersParameters)
