...
# [ApiPlatform\Doctrine\Odm\Filter\BooleanFilter](/docs/v3.1/reference/Doctrine/Odm/Filter/BooleanFilter)
...
```php
class ApiPlatform\Doctrine\Odm\Filter\BooleanFilter extends `<a href="/docs/v3.1/reference/Doctrine/Odm/Filter/AbstractFilter">ApiPlatform\Doctrine\Odm\Filter\AbstractFilter</a>` implements `<a href="/docs/v3.1/reference/Api/FilterInterface">ApiPlatform\Api\FilterInterface</a>`, `<a href="/docs/v3.1/reference/Metadata/FilterInterface">ApiPlatform\Metadata\FilterInterface</a>`, `<a href="/docs/v3.1/reference/Doctrine/Odm/Filter/FilterInterface">ApiPlatform\Doctrine\Odm\Filter\FilterInterface</a>`
{
