...
# [ApiPlatform\Serializer\Filter\GroupFilter](/docs/v3.2/reference/Serializer/Filter/GroupFilter)
...
```php
class ApiPlatform\Serializer\Filter\GroupFilter implements `<a href="/docs/v3.2/reference/Serializer/Filter/FilterInterface">ApiPlatform\Serializer\Filter\FilterInterface</a>`, `<a href="/docs/v3.2/reference/Api/FilterInterface">ApiPlatform\Api\FilterInterface</a>`
{
