...
# [ApiPlatform\Doctrine\Odm\Filter\DateFilter](/docs/v3.2/reference/Doctrine/Odm/Filter/DateFilter)
...
```php
class ApiPlatform\Doctrine\Odm\Filter\DateFilter extends `<a href="/docs/v3.2/reference/Doctrine/Odm/Filter/AbstractFilter">ApiPlatform\Doctrine\Odm\Filter\AbstractFilter</a>` implements `<a href="/docs/v3.2/reference/Doctrine/Odm/Filter/FilterInterface">ApiPlatform\Doctrine\Odm\Filter\FilterInterface</a>`, `<a href="/docs/v3.2/reference/Api/FilterInterface">ApiPlatform\Api\FilterInterface</a>`, `<a href="/docs/v3.2/reference/Doctrine/Common/Filter/DateFilterInterface">ApiPlatform\Doctrine\Common\Filter\DateFilterInterface</a>`
{
