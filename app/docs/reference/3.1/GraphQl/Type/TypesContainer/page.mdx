...
# [ApiPlatform\GraphQl\Type\TypesContainer](/docs/v3.1/reference/GraphQl/Type/TypesContainer)

Container having the built GraphQL types.


```php
class ApiPlatform\GraphQl\Type\TypesContainer implements `<a href="/docs/v3.1/reference/GraphQl/Type/TypesContainerInterface">ApiPlatform\GraphQl\Type\TypesContainerInterface</a>`, Psr\Container\ContainerInterface
{
