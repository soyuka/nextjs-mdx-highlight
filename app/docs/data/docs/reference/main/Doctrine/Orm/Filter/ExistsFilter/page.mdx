...
# [ApiPlatform\Doctrine\Orm\Filter\ExistsFilter](/docs/vmain/reference/Doctrine/Orm/Filter/ExistsFilter)
...
```php
class ApiPlatform\Doctrine\Orm\Filter\ExistsFilter extends `<a href="/docs/vmain/reference/Doctrine/Orm/Filter/AbstractFilter">ApiPlatform\Doctrine\Orm\Filter\AbstractFilter</a>` implements `<a href="/docs/vmain/reference/Doctrine/Orm/Filter/FilterInterface">ApiPlatform\Doctrine\Orm\Filter\FilterInterface</a>`, `<a href="/docs/vmain/reference/Metadata/FilterInterface">ApiPlatform\Metadata\FilterInterface</a>`, `<a href="/docs/vmain/reference/Doctrine/Common/Filter/ExistsFilterInterface">ApiPlatform\Doctrine\Common\Filter\ExistsFilterInterface</a>`
{
