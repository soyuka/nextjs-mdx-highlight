...
# [ApiPlatform\Serializer\Filter\PropertyFilter](/docs/v3.1/reference/Serializer/Filter/PropertyFilter)
...
```php
class ApiPlatform\Serializer\Filter\PropertyFilter implements `<a href="/docs/v3.1/reference/Serializer/Filter/FilterInterface">ApiPlatform\Serializer\Filter\FilterInterface</a>`, `<a href="/docs/v3.1/reference/Metadata/FilterInterface">ApiPlatform\Metadata\FilterInterface</a>`, `<a href="/docs/v3.1/reference/Api/FilterInterface">ApiPlatform\Api\FilterInterface</a>`
{
