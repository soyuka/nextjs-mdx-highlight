...
# [ApiPlatform\Doctrine\Orm\Filter\BooleanFilter](/docs/vmain/reference/Doctrine/Orm/Filter/BooleanFilter)
...
```php
class ApiPlatform\Doctrine\Orm\Filter\BooleanFilter extends `<a href="/docs/vmain/reference/Doctrine/Orm/Filter/AbstractFilter">ApiPlatform\Doctrine\Orm\Filter\AbstractFilter</a>` implements `<a href="/docs/vmain/reference/Metadata/FilterInterface">ApiPlatform\Metadata\FilterInterface</a>`, `<a href="/docs/vmain/reference/Doctrine/Orm/Filter/FilterInterface">ApiPlatform\Doctrine\Orm\Filter\FilterInterface</a>`
{
