...
# [ApiPlatform\Doctrine\Orm\Filter\BooleanFilter](/docs/v3.2/reference/Doctrine/Orm/Filter/BooleanFilter)
...
```php
class ApiPlatform\Doctrine\Orm\Filter\BooleanFilter extends `<a href="/docs/v3.2/reference/Doctrine/Orm/Filter/AbstractFilter">ApiPlatform\Doctrine\Orm\Filter\AbstractFilter</a>` implements `<a href="/docs/v3.2/reference/Api/FilterInterface">ApiPlatform\Api\FilterInterface</a>`, `<a href="/docs/v3.2/reference/Doctrine/Orm/Filter/FilterInterface">ApiPlatform\Doctrine\Orm\Filter\FilterInterface</a>`
{
