...
# [ApiPlatform\Doctrine\Odm\Filter\AbstractFilter](/docs/vmain/reference/Doctrine/Odm/Filter/AbstractFilter)
...
```php
class ApiPlatform\Doctrine\Odm\Filter\AbstractFilter implements `<a href="/docs/vmain/reference/Doctrine/Odm/Filter/FilterInterface">ApiPlatform\Doctrine\Odm\Filter\FilterInterface</a>`, `<a href="/docs/vmain/reference/Metadata/FilterInterface">ApiPlatform\Metadata\FilterInterface</a>`
{
