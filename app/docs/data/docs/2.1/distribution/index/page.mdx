...
2. Handcraft the API data model as _Plain Old PHP Objects_
...
Try to create a new _Foo_ resource using the `POST` operation, then access it using the `GET` operation and, finally, delete
