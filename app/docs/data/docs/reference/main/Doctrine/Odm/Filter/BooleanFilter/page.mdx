...
# [ApiPlatform\Doctrine\Odm\Filter\BooleanFilter](/docs/vmain/reference/Doctrine/Odm/Filter/BooleanFilter)
...
```php
class ApiPlatform\Doctrine\Odm\Filter\BooleanFilter extends `<a href="/docs/vmain/reference/Doctrine/Odm/Filter/AbstractFilter">ApiPlatform\Doctrine\Odm\Filter\AbstractFilter</a>` implements `<a href="/docs/vmain/reference/Metadata/FilterInterface">ApiPlatform\Metadata\FilterInterface</a>`, `<a href="/docs/vmain/reference/Doctrine/Odm/Filter/FilterInterface">ApiPlatform\Doctrine\Odm\Filter\FilterInterface</a>`
{
