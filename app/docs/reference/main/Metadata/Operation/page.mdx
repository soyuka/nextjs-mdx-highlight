...
# [ApiPlatform\Metadata\Operation](/docs/vmain/reference/Metadata/Operation)

⚠ This class and its children offer no backward compatibility regarding positional parameters.

```php
class ApiPlatform\Metadata\Operation extends `<a href="/docs/vmain/reference/Metadata/Metadata">ApiPlatform\Metadata\Metadata</a>`
{
...
`<a href="/docs/vmain/reference/Metadata/Operation">ApiPlatform\Metadata\Operation</a>`
