...
# [ApiPlatform\Serializer\Filter\GroupFilter](/docs/vmain/reference/Serializer/Filter/GroupFilter)
...
```php
class ApiPlatform\Serializer\Filter\GroupFilter implements `<a href="/docs/vmain/reference/Serializer/Filter/FilterInterface">ApiPlatform\Serializer\Filter\FilterInterface</a>`, `<a href="/docs/vmain/reference/Metadata/FilterInterface">ApiPlatform\Metadata\FilterInterface</a>`
{
