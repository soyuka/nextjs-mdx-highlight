...
# [ApiPlatform\Doctrine\Orm\Filter\NumericFilter](/docs/vmain/reference/Doctrine/Orm/Filter/NumericFilter)
...
```php
class ApiPlatform\Doctrine\Orm\Filter\NumericFilter extends `<a href="/docs/vmain/reference/Doctrine/Orm/Filter/AbstractFilter">ApiPlatform\Doctrine\Orm\Filter\AbstractFilter</a>` implements `<a href="/docs/vmain/reference/Metadata/FilterInterface">ApiPlatform\Metadata\FilterInterface</a>`, `<a href="/docs/vmain/reference/Doctrine/Orm/Filter/FilterInterface">ApiPlatform\Doctrine\Orm\Filter\FilterInterface</a>`
{
