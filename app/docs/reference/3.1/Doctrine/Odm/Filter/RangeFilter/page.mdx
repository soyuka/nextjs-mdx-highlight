...
# [ApiPlatform\Doctrine\Odm\Filter\RangeFilter](/docs/v3.1/reference/Doctrine/Odm/Filter/RangeFilter)
...
```php
class ApiPlatform\Doctrine\Odm\Filter\RangeFilter extends `<a href="/docs/v3.1/reference/Doctrine/Odm/Filter/AbstractFilter">ApiPlatform\Doctrine\Odm\Filter\AbstractFilter</a>` implements `<a href="/docs/v3.1/reference/Doctrine/Odm/Filter/FilterInterface">ApiPlatform\Doctrine\Odm\Filter\FilterInterface</a>`, `<a href="/docs/v3.1/reference/Metadata/FilterInterface">ApiPlatform\Metadata\FilterInterface</a>`, `<a href="/docs/v3.1/reference/Api/FilterInterface">ApiPlatform\Api\FilterInterface</a>`, `<a href="/docs/v3.1/reference/Doctrine/Common/Filter/RangeFilterInterface">ApiPlatform\Doctrine\Common\Filter\RangeFilterInterface</a>`
{
    protected filterProperty(string $property, $values, Doctrine\ODM\MongoDB\Aggregation\Builder $aggregationBuilder, string $resourceClass, null|`<a href="/docs/v3.1/reference/Metadata/Operation">ApiPlatform\Metadata\Operation</a>` $operation, array $context): null
    protected addMatch(Doctrine\ODM\MongoDB\Aggregation\Builder $aggregationBuilder, string $field, string $matchField, string $operator, string $value): null
...
<table><tbody>
<tr><td>aggregationBuilder</td><td>Doctrine\ODM\MongoDB\Aggregation\Builder</td><td></td></tr><tr><td>field</td><td>string</td><td></td></tr><tr><td>matchField</td><td>string</td><td></td></tr><tr><td>operator</td><td>string</td><td></td></tr><tr><td>value</td><td>string</td><td></td></tr>
</tbody>
</table>
